...
sender_address = 'susmitha2002reddy@gmail.com' #enter sender's email id
sender_pass = 'odfbiwhtvmblugyj' #enter sender's password

app=Flask(__name__)
app.config['SECRET_KEY']='odfbiwhtvmblugyj'
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                if (conf > 40):
                    ...
                    cv2.putText(im, f"Pin Number: {det_aadhar}", (x, y + h), font, 1, (255, 255, 255), 2)
                else:
